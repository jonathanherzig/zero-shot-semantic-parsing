...
class Example(object):
  ...
  """
  def __init__(self, x_str, y_str, x_orig, y_orig, x_orig_same, y_orig_same, src_domain, pos, input_vocab, output_vocab, d_inds, lex,
               reverse_input=False):
    ...
    self.x_orig = x_orig
    self.y_orig = y_orig
    self.y_orig_same = y_orig_same
    self.x_orig_same = x_orig_same
    self.x_orig_toks = x_orig.split(' ')
